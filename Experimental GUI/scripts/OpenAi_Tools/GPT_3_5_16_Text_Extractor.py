...
class ChatBotApplication(tk.Frame):
    ...
    def process_message(self, a):
        ...
        t = threading.Thread(target=self.GPT_3_5_16_Text_Extractor_Monologue, args=(a,))
        t.start()
    ...
    def open_fileprocess_window(self):
        ...
        search_button = tk.Button(fileprocess_window, text="Process", command=GPT_3_5_16_Text_Extract)
        search_button.pack()
    ...
    def GPT_3_5_16_Text_Extractor_Monologue(self, a):
        vdb = pinecone.Index("aetherius")
     ...
     #   r = sr.Recognizer()
        ...
        #    a = input(f'\n\nUSER: ')
           ...
           # # # Inner Monologue Generation
            ...
            t = threading.Thread(target=self.GPT_3_5_16_Text_Extractor_Intuition, args=(a, vector_input, output_one, int_conversation, tasklist_output))
            t.start()
            return
    ...
    def GPT_3_5_16_Text_Extractor_Intuition(self, a, vector_input, output_one, int_conversation, tasklist_output):
        vdb = pinecone.Index("aetherius")
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
        conv_length = 4
        m = multiprocessing.Manager()
    ...
    #                print('Invalid Input')
            ...
            t = threading.Thread(target=self.GPT_3_5_16_Extractor_Response, args=(a, vector_input, vector_monologue, output_one, output_two, tasklist_new))
            t.start()
            return 
    ...
    def GPT_3_5_16_Extractor_Response(self, a, vector_input, vector_monologue, output_one, output_two, tasklist_new):
        vdb = pinecone.Index("aetherius")
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
        conv_length = 4
        m = multiprocessing.Manager()
    ...
    def GPT_3_5_16_Extractor_Memories(self, a, vector_input, vector_monologue, output_one, output_two, tasklist_new):
        vdb = pinecone.Index("aetherius")
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
        conv_length = 4
        m = multiprocessing.Manager()
