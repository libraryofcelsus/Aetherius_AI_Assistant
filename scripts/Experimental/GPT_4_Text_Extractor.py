...
def search_file_process_db(line):
    ...
    try:
        with lock:
            ...
            results = vdb.query(vector=line_vec, filter={
        "memory_type": "file_process"}, top_k=30, namespace=f'{username}_short_term_memory')
 ...
 #   r = sr.Recognizer()
    ...
    #    print(tasklist_output)
        ...
        "memory_type": "episodic"}, top_k=5, namespace=f'{username}'),
                ...
                executor.submit(lambda: (
                    vdb.query(vector=vector_input, filter={
        "memory_type": "explicit_short_term"}, top_k=8, namespace=f'{username}'),
       ...
       # # # Inner Monologue Generation
        ...
        "memory_type": "file_process"}, top_k=7, namespace=f'{username}short_term_memory')
