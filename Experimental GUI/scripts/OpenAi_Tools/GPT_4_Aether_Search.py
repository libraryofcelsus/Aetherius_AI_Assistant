...
class ChatBotApplication(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.clear_websearch_button = tk.Button(self.top_frame, text="Delete Web History", command=self.delete_web_history, bg=self.button_color, fg=self.text_color)
        self.clear_websearch_button.pack(side=tk.LEFT, padx=5, pady=5, ipadx=10)
