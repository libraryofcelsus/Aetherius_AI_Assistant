 ...
 #   r = sr.Recognizer()
    ...
    #        pass                 
        ...
        if namespace_name in namespace_stats and namespace_stats[namespace_name]['vector_count'] > 25:
            ...
            results = vdb.query(vector=vector_input, filter={
        "memory_type": "explicit_short_term", "user": username}, top_k=25, namespace=f'short_term_memory_User_{username}_Bot_{bot_name}')
            ...
            results = vdb.query(vector=vector_input, filter={
        "memory_type": "implicit_short_term"}, top_k=20, namespace=f'short_term_memory_User_{username}_Bot_{bot_name}')
        ...
        "memory_type": "implicit_long_term", "user": username}, top_k=8, namespace=f'{bot_name}')
        ...
        "memory_type": "explicit_long_term", "user": username}, top_k=10, namespace=f'{bot_name}')
