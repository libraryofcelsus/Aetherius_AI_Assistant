...
class OpenAiToolsMenu(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.title('Aetherius OpenAi Tools Menu')
        ...
        files = os.listdir('scripts/OpenAi_Tools')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/OpenAi_Tools/{script}")
...
def Menu_OpenAi_Tools(parent):
    OpenAiToolsMenu(parent)