...
class OobaboogaChatbotMenu(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.title('Aetherius Oobabooga Api Menu')
        ...
        files = os.listdir('scripts/Oobabooga_Api')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/Oobabooga_Api/{script}")
