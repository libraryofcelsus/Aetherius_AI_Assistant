...
def GPT_3_5_Chat_Manual():
 ...
 #   r = sr.Recognizer()
    ...
    #    auto.append({'role': 'assistant', 'content': "I will now review the user's message and my reply, rating whether my response is both pertinent to the user's inquiry and my growth with an integer on a scale of 1-10. I will now give my answer in digit form: "})
