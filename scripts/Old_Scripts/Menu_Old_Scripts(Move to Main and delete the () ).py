...
class OldScriptsMenu(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.title('Aetherius Old Script Menu')
        ...
        files = os.listdir('scripts/Old_Scripts')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/Old_Scripts/{script}")
...
def Menu_Old_Scripts(parent):
    OldScriptsMenu(parent)