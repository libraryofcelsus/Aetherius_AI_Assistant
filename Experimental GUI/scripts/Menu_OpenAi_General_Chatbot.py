...
class OpenAiChatbotMenu(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.title('Aetherius OpenAi General Chatbot Menu')
        ...
        files = os.listdir('scripts/OpenAi_General_Chatbot')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/OpenAi_General_Chatbot/{script}")
...
def Menu_OpenAi_General_Chatbot(parent):
    OpenAiChatbotMenu(parent)