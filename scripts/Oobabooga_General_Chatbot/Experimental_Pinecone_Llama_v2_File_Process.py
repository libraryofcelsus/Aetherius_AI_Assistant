...
class ChatBotApplication(tk.Frame):
    ...
    def delete_fileprocess_db(self):
        ...
        try:
            ...
            self.master.destroy()
            Experimental_Pinecone_Llama_v2_File_Process()
        except:
            print("Fail")
            pass
     ...
     #   r = sr.Recognizer()
       ...
       #     a = input(f'\n\nUSER: ')
        ...
        #    print(tasklist_output)
            ...
            "memory_type": "file_process"}, top_k=8, namespace=f'Tools_User_{username}_Bot_{bot_name}')
            ...
            "memory_type": "heuristics", "user": username}, top_k=5, namespace=f'{bot_name}')
                ...
                try:
                    ...
                    db_search_2 = load_conversation_file_process_memory(future2.result())
...
def Experimental_Pinecone_Llama_v2_File_Process():
    bot_name = open_file('./config/prompt_bot_name.txt')
    username = open_file('./config/prompt_username.txt')
