...
class OpenAiChatbotMenu(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.title('Aetherius OpenAi Api Menu')
        ...
        files = os.listdir('scripts/OpenAi_Api')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/OpenAi_Api/{script}")
