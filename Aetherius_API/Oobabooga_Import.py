...
def chunk_text_from_url(url, username, bot_name, chunk_size=380, overlap=40, results_callback=None):
    try:
...
def summarized_chunk_from_url(host, chunk, collection_name, bot_name, username, embeddings, client, url, results_callback=None):
    try:
        ...
        text = scrape_oobabooga_scrape(host, prompt, username, bot_name)
        ...
        if 'i am an ai' in text.lower():
            ...
            if 'yes' in webyescheck.lower():
                ...
                semantic_db_term = scrape_oobabooga_scrape(host, prompt, username, bot_name)
