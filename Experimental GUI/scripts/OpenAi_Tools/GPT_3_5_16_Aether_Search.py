...
class ChatBotApplication(tk.Frame):
    ...
    def open_websearch_window(self):
        ...
        def perform_search():
            ...
            def search_task():
                # Call the modified GPT_3_5_16_Tasklist_Web_Search function with the callback
                GPT_3_5_16_Tasklist_Web_Search(query, results_callback=update_results)
    ...
    def open_webscrape_window(self):
        ...
        def perform_search():
            ...
            def search_task():
                # Call the modified GPT_3_5_16_Tasklist_Web_Search function with the callback
                GPT_3_5_16_Tasklist_Web_Scrape(query, results_callback=update_results)
    ...
    def process_message(self, a):
        ...
        self.conversation_text.yview(tk.END)
        # Here, we're calling your GPT_3_5_16_Training function in a separate thread
        t = threading.Thread(target=self.GPT_3_5_16_Tasklist_Inner_Monologue, args=(a,))
        t.start()


    def GPT_3_5_16_Tasklist_Web_Search(query):
        vdb = pinecone.Index("aetherius")
     ...
     #   r = sr.Recognizer()
        ...
        #    query = input(f'\nEnter search term to scrape: ')
            ...
            # After the operations are complete, call the GPT_3_5_16_Intuition function in a separate thread
    ...
    def GPT_3_5_16_Tasklist_Inner_Monologue(self, a):
        vdb = pinecone.Index("aetherius")
        my_api_key = open_file('api_keys/key_google.txt')
        my_cse_id = open_file('api_keys/key_google_cse.txt')
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
     ...
     #   r = sr.Recognizer()
       ...
       #     a = input(f'\n\nUSER: ')
        ...
        #    print(tasklist_output)
            ...
            # After the operations are complete, call the GPT_3_5_16_Intuition function in a separate thread
            t = threading.Thread(target=self.GPT_3_5_16_Tasklist_Intuition, args=(a, vector_input, output_one, int_conversation, tasklist_output))
            t.start()
            return
    ...
    def GPT_3_5_16_Tasklist_Intuition(self, a, vector_input, output_one, int_conversation, tasklist_output):
        vdb = pinecone.Index("aetherius")
        my_api_key = open_file('api_keys/key_google.txt')
        my_cse_id = open_file('api_keys/key_google_cse.txt')
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
    ...
    #                print('Invalid Input')
            ...
            t = threading.Thread(target=self.GPT_3_5_16_Tasklist_Response, args=(a, vector_input, vector_monologue, output_one, output_two, tasklist_output))
            t.start()
            return  
    ...
    def GPT_3_5_16_Tasklist_Response(self, a, vector_input, vector_monologue, output_one, output_two, tasklist_output):
        vdb = pinecone.Index("aetherius")
        my_api_key = open_file('api_keys/key_google.txt')
        my_cse_id = open_file('api_keys/key_google_cse.txt')
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
    ...
    #        t = threading.Thread(target=self.GPT_3_5_16_Memories, args=(a, vector_input, vector_monologue, output_one, response_two))
    #        t.start()
            self.conversation_text.yview(tk.END)
            self.user_input.delete(0, tk.END)
    ...
    def GPT_3_5_16_Response(self, a, output_one, output_two):
        vdb = pinecone.Index("aetherius")
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
        m = multiprocessing.Manager()
        lock = m.Lock()
   ...
   #         a = input(f'\n\nUSER: ')
    ...
    def GPT_3_5_16_Memories(self, a, vector_input, vector_monologue, output_one, response_two):
        vdb = pinecone.Index("aetherius")
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
        m = multiprocessing.Manager()
        lock = m.Lock()
...
def GPT_3_5_16_Tasklist_Web_Search(query, results_callback):
    vdb = pinecone.Index("aetherius")
    my_api_key = open_file('api_keys/key_google.txt')
    my_cse_id = open_file('api_keys/key_google_cse.txt')
        # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
...
def GPT_3_5_16_Tasklist_Web_Scrape(query, results_callback):
    vdb = pinecone.Index("aetherius")
    my_api_key = open_file('api_keys/key_google.txt')
    my_cse_id = open_file('api_keys/key_google_cse.txt')
    # # Number of Messages before conversation is summarized, higher number, higher api cost. Change to 3 when using GPT 3.5 due to token usage.
