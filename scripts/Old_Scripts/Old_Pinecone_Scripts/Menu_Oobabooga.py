...
class OobaboogaMenu(tk.Toplevel):
    def __init__(self):
        super().__init__()
        ...
        files = os.listdir('scripts/Old_Scripts/Old_Pinecone_Scripts/Oobabooga')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/Old_Scripts/Old_Pinecone_Scripts/Oobabooga/{script}")
