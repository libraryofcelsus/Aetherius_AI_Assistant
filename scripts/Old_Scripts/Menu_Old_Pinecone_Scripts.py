...
class OldPineconeMenu(tk.Toplevel):
    def __init__(self):
        super().__init__()
        customtkinter.set_appearance_mode("Dark")  # Modes: "System" (standard), "Dark", "Light"
        self.title('Aetherius Pinecone/Oobabooga Menu')
        ...
        files = os.listdir('scripts/Old_Scripts/Old_Pinecone_Scripts')
    ...
    def run_script(self, script):
        ...
        # Import the module
        spec = importlib.util.spec_from_file_location(module_name, f"scripts/Old_Scripts/Old_Pinecone_Scripts/{script}")
